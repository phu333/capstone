                ...
                <div style={{ fontSize: 14, height: '100vh' }} >
                    ...
                    <Space direction='vertical' align='center' style={{ backgroundColor: 'white' }} >
                        ...
                        <Space direction='vertical' style={{ backgroundColor: 'white' }} >
                            <input type="text" pattern="[0-9]*" prefix="VND"
                            ...
                            <Space direction='vertical' align='center' style={{ backgroundColor: 'white' }} >
                                <Card bordered={false}>
                                    ...
                                    >
                                        ...
                                        <h6 style={{ fontSize: 14 }}>Hợp đồng có hiệu lực kể từ ngày {today.getDate()} tháng {today.getMonth() + 1} năm {today.getFullYear()} đến
                                        <input 
                                            type="text"
